...
<body>
            ...
            <div class="offset-md-7 col-md-5 col-lg-4  ">
                ...
                <form id="formLogin" name="formLogin" class="user">
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user campo-obrigatorio obrigatorio" id="usuario" name="usuario" placeholder="Usuário" maxlength="18" />
                    </div>
                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="usuario" type="text" name="usuario" class="form-control campo-obrigatorio obrigatorio" placeholder="Por favor insira o CNPJ cadastrado *" required="required" maxlength="18">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
    ...
    <script type="text/javascript" src="<?php echo HTTP_SERVER; ?>portal/modulos/controleAcesso/js/login.js?14"></script>
</body>
