...
<body class="home">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <a href="../modulos/timesheet/fragment/timesheet.frag.php">
                                <div class="img d-flex justify-content-end">
            ...
            <div class="col-sm-12 col-md-4 ">
                <div class="card-2 m-auto">
                    <div class="card-body">
                        ...
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" style="" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                            <div class='without-progress'>00:00</div>
                        </div>
                        <span id="wedText" class="day"></span>
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" style="" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                            <div class='without-progress'>00:00</div>
                        </div>
                        ...
                        <a href="../modulos/timesheet/fragment/reportTimesheet.frag.php" class="btn btn-view-all">Ver
                            tudo</a>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="modalCamposObrigatorios" tabindex="-1" role="dialog"  data-backdrop="static" data-keyboard="false">
                                    ...
                                    <div class="body-multi-content px-0">
                                        <div id="meusDados" class="form-row">
                                            <div class="col-12 container-body justify-content-center">
                                                <h5 class="body-modal font-weight-bold"> Caro profissional, é muito importante que você atualize a sua quantidade de filhos na aba meus dados.
                                                     A BlueShift sempre tem novidades para os seus colaboradores e é importante o preenchimento tanto de quem tem filhos como de quem não tem para que vocês não fiquem de fora! </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
