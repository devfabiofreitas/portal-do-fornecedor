function DadosCadastrais() {
  ...
  this.init = function () {
     ...
     */
    $('.validarCampo').on('change', function() {
      $(this).attr("data-verificar", true)
    })
    ...
    $("#btnPreencherDadosFaltantes").click(function () {
    ...
    /**
     * Exibe um alerta ao trocar de menu, se houve alteracao
     * em algum campo
     */
    var deixarStep = true
    $('#smartwizard').on('leaveStep', function (e, anchorObject, currentStepIndex, nextStepIndex, stepDirection) {
      if(deixarStep){
      var index = parseInt(currentStepIndex) + 1;
      var verificarStep = false;
      $("#step-"+index).find("form .validarCampo").each(function(){
        if($(this).attr("data-verificar") == "true"){
          verificarStep = true;
        }
        ...
        if (verificarStep) {
            ...
            Swal.fire({
                ...
                text: "Os dados alterados não foram salvos! Deseja continuar?",
                icon: 'warning',
                customClass: "false",
                cancelButtonColor: "#15CB76",
                ...
                $("#step-"+index).find("button.btn-alterar").click();
