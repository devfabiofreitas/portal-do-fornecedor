...
function atualizar_dados_consultor(array $form_data, int $usuario_codigo, DoFramwork $do): bool
{
    ...
    $nomeEmergencia = $form_data['nomeEmergencia'];
    $emailPessoal = $form_data['emailPessoal'];
...
function atualizar_dados_empresa(array $form_data, int $usuario_codigo, DoFramwork $do): bool
{
    ...
    $razaoSocial = $form_data['razaoSocial'];
    $nomeFantasia = $form_data['nomeFantasia'];
    $logradouro = $form_data['logradouro'];
    $bairro = $form_data['bairro'];
    $complemento = $form_data['complemento'];
    $tipo = $form_data['tipo'];
    $naturezaJuridica = $form_data['naturezaJuridica'];
