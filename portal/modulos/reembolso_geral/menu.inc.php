<li id="projetos" class="menus">
    <a href="javascript:void(0)" onclick="link('reembolso_geral/fragment/reembolso_geral.frag.php?menu=reembolso_geral')">
        <div class="w-100">
            <svg id="Camada_2" data-name="Camada 2" xmlns="http://www.w3.org/2000/svg" width="20.459" height="19.991" viewBox="0 0 20.459 19.991">
            ...
            <span class="fonte-menu">Reembolso Geral</span>
        </div>
    </a>
</li>