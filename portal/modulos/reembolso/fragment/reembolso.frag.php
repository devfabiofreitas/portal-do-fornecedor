            ...
            <div class="col-lg-6 col-xg-6 col-md-6 col-sm-8  col-10 flex-fl justify-content-end">
              <div id="container-buttons-table" class="d-flex">
                <div id="toolbar float-right" class="mt-2 mb-3">
                  <button type="button" id="newReembolso" class="btn btn-timesheet btn-outline-success">
                    NOVO
                  </button>
                </div>
              </div>
                            ...
                            <div class="upload mb-5">
                              ...
                              <div class="area-upload">
                                <div class="area-upload-body position-relative">
                                  ...
                                  <input type="file" class="inputUpload obrigatorio" accept=".pdf " id="uploadFile" title="" />
                                </div>
...
<script type="text/javascript" src="<?php echo HTTP_SERVER; ?>portal/modulos/reembolso/js/reembolso_function.js?30">
