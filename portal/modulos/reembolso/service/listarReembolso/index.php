...
$sqlCommand  = ' SELECT ';
$sqlCommand .= '   codigo, item, tipoItem, cpf, bancoNumero, banco, agencia, agenciaDigito, conta, contaDigito, caminhoNota, status, valorReembolso, dataCadastro ';
$sqlCommand .= ' FROM ';
...
function verificarReembolsoAnterior()
{
}
