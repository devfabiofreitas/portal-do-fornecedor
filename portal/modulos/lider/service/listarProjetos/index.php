...
$sqlCommand .= '     t.Project, t.Projeto_codigo ';
$sqlCommand .= ' FROM ';
$sqlCommand .= '     timesheet t ';
$sqlCommand .= ' LEFT JOIN responsaveis_tecnicos rt on rt.codigo = t.Responsavel_codigo';
$sqlCommand .= ' WHERE ';
$sqlCommand .= '  rt.Lider_codigo = ' . $usuarioCodigo;
$sqlCommand .= '  GROUP BY t.Projeto_codigo ORDER BY t.Project ASC ; ';
$do->begin();
