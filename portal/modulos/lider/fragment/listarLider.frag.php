...
<head>
  ...
  <link rel="stylesheet" href="<?php echo HTTP_SERVER; ?>portal/modulos/lider/css/style.css?20">
</head>
...
<body class="home">
  <div class="container-fluid pt-4">
      ...
      <div class="container-fluid header-pag py-2">
        <div class="row">
          <div class="col-8 col-md-8">
            <h1 class="mb-0 text-header"><span class="font-cairo-bold">Colaboradores</span></h1>
          </div>
          <div class="col-4 col-md-4 filtro">
            <div class="form-group">
              <div class="d-md-flex justify-content-end container-reportrange">
                ...
                <div id="reportrange" style="background: #fff; cursor: pointer; padding: 3px 10px 3px 13px; border: 1px solid #ccc;" class="reportrange-hp colaboradoresLiderados">
    ...
    <div id="main-body">
      <div class="container-table mt-2 ml-4 mr-4">
        ...
        <div class="modal-body bg-white">
          <form id="formFiltro">
            <div class="form-row">
              ...
              <div class="col-12 form-group clienteProjeto">
                <label for="filtroCliente">Cliente </label>
                <select type="text" id="filtroCliente" name="Cliente_codigo" class="form-control rounded-pill input-modal"></select>
              </div>
              <div class="col-12 form-group clienteProjeto">
                <label for="filtroProjeto">Projeto </label>
                <select type="text" id="filtroProjeto" name="Projeto_codigo" class="form-control rounded-pill input-modal"></select>
              </div>
            </div>
          </form>
        </div>
  ...
  <script type="text/javascript" src="<?php echo HTTP_SERVER; ?>portal/modulos/lider/js/logicaReport_function.js?10"></script>
  <script type="text/javascript" src="<?php echo HTTP_SERVER; ?>portal/modulos/lider/js/reportTimesheet_function.js?20"></script>
  <script src="<?php echo HTTP_SERVER; ?>portal/modulos/lider/js/lider_function.js?5"></script>
</body>
