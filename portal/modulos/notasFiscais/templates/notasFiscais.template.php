...
<head>
    ...
    <link rel="stylesheet" href="<?php echo HTTP_SERVER ?>portal/modulos/notasFiscais/public/css/style.css?13">
</head>
...
<body class="home">
    ...
    <script src="<?php echo HTTP_SERVER; ?>portal/modulos/notasFiscais/public/js/notasFiscais.js?23"></script>
