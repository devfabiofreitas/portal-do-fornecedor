...
<body class="home">
                        ...
                        <div id="step-1" class="tab-pane" role="tabpanel">
                            <div class="card-body accordian">
                                <div class="px-2" data-value="responsavelTecnico">
                                    <div class="px-3">
                                        <form class="validar formValidar" id="formResponsavelTecnico" name="formResponsavelTecnico" action="cadastroDados.php" method="POST">
                                            <div class="body-multi-content p-0">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        ...
                                                        <select id="telefonePais" name="telefonePais" class="form-control rounded-pill tipoTelefone obrigatorio" required>
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        ...
                                                        <input type="text" id="telefone" name="telefone" class="form-control rounded-pill  mask-celular obrigatorio" required value="<?= $dados_colaborador['telefone'] ?>">
                                                    </div>
                                                    <div class="col-md-4 form-group">
                                                        <label for="emailPessoal">Email pessoal <span class="text-danger">*</span></label>
                                                        <input type="text" id="emailPessoal" name="emailPessoal" class="form-control rounded-pill obrigatorio" required value="<?= $dados_colaborador['emailPessoal'] ?>">
                                                    </div>
                                                    <div class="col-md-2 form-group">
                                                        <label for="dataNascimento">Data de nascimento <span class="text-danger">*</span></label>
                                                        <input type="text" id="dataNascimento" name="dataNascimento" class="form-control mask-data rounded-pill" required value="<?= $data_nascimento_formatada ?>">
                                                    </div>
                                                    <div class="col-md-3 form-group">
                                                        <label for="telefonePaisEmergencia">Selecione o País <span class="text-danger">*</span></label>
                                                        <select id="telefonePaisEmergencia" name="telefonePaisEmergencia" class="form-control rounded-pill tipoTelefone obrigatorio" required>
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        ...
                                                        <input type="text" id="telefoneEmergencia" name="telefoneEmergencia" class="form-control rounded-pill mask-celular obrigatorio" required value="<?= $dados_colaborador['telefoneEmergencia'] ?>">
                                                    </div>
                                                    <div class="col-md-3 form-group">
                                                        <label for="contatoEmergencia">Contato para emergência<span class="text-danger">*</span></label>
                                                        <input type="text" id="nomeEmergencia" name="nomeEmergencia" placeholder="Ex: João (pai)" class="form-control rounded-pill obrigatorio" required value="<?= $dados_colaborador['nomeEmergencia'] ?>">
                                                    </div>
                                                    <div class="col-md-2 form-group">
                                                        <label for="qtdFilhos">Quantidade de filhos<span class="text-danger">*</span></label>
                                                        <input type="number" id="qtdFilhos" name="qtdFilhos" class="form-control obrigatorio rounded-pill" required value="<?= $qtdFilhos_colaborador['qtdFilhos'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="text-center botaoDados mt-5">
                                                <input type="hidden" name="codigoUsuario" value="<?= $usuario_codigo ?>">
                                                <button type="submit" class="btn btn-success rounded-pill " name="action" value="atualizarDados">
                                                    Salvar
                                                </button>
                                            </div>
                                        </form>
                            ...
                            <div id="step-2" class="tab-pane" role="tabpanel">
                                <div class="card-body">
                                    <div class="px-2" data-value="dadosEmpresa">
                                        <div class="px-3">
                                            <form class="formValidar" id="formDadosEmpresa" action="cadastroDados.php" method="POST" name="formDadosEmpresa">
                                                <div class="body-multi-content px-0">
                                                    <div class="row">
                                                        <div class=" col-md-6  form-group">
                                                            <label for="cnpj">CNPJ <span class="text-danger">*</span></label>
                                                            <input type="text" id="cnpj" name="cnpj" class="form-control  input-invisivel mask-cnpj rounded-pill" value="<?= $dados_colaborador['cnpj'] ?>" readonly maxlength="18">
                                                        </div>
                                                        <div class="col-md-6 form-group">
                                                        ...
                                                        <div class=" col-md-6 form-group">
                                                            ...
                                                            <input type="text" id="razaoSocial" name="razaoSocial" class="form-control input-invisivel obrigatorio rounded-pill" value="<?= $dados_colaborador['razaoSocial'] ?>" readonly>
                                                        </div>
                                                        <div class="col-md-6 form-group">
                                                            <label for="nomeFantasia">Nome fantasia </label>
                                                            <input type="text" id="nomeFantasia" name="nomeFantasia" class="form-control input-invisivel rounded-pill" value="<?= $dados_colaborador['nomeFantasia'] ?>" readonly>
                                                        </div>
                                                        <div class="col-md-2 form-group">
                                                            <label for="tipo">Tipo </label>
                                                            <input type="text" id="tipo" name="tipo" class="form-control input-invisivel rounded-pill " value="<?= $dados_colaborador['tipo'] ?>" readonly>
                                                        </div>
                                                        <div class="col-md-4  form-group">
                                                            <label for="porte">Porte </label>
                                                            <input type="text" id="porte" name="porte" class="form-control input-invisivel rounded-pill " value="<?= $dados_colaborador['porte'] ?>" readonly>
                                                        </div>
                                                        <div class=" col-md-4  form-group">
                                                            <label for="naturezaJuridica">Natureza jurídica </label>
                                                            <input type="text" id="naturezaJuridica" name="naturezaJuridica" class="form-control input-invisivel rounded-pill " value="<?= $dados_colaborador['naturezaJuridica'] ?>" readonly>
                                                        </div>
                                                        <div class="col-md-2 form-group">
                                                            <label for="dataAbertura">Data de abertura <span class="text-danger">*</span></label>
                                                            <input type="date" id="dataAbertura" name="dataAbertura" class="form-control rounded-pill obrigatorio input-invisivel" value="<?= $dados_colaborador['dataAbertura'] ?>" readonly>
                                                        </div>
                                                        <div class="col-md-2 form-group">
                                                            <label for="cep">CEP <span class="text-danger">*</span></label>
                                                            <input type="text" id="cep" name="cep" class="form-control rounded-pill obrigatorio input-invisivel cep mask-cep" value="<?= $dados_colaborador['cep'] ?>" readonly>
                                                        </div>
                                                        <div class=" col-md-5  form-group">
                                                            <label for="logradouro">Logradouro <span class="text-danger">*</span></label>
                                                            <input type="text" id="logradouro" name="logradouro" class="form-control obrigatorio input-invisivel rounded-pill logradouro" value="<?= $dados_colaborador['logradouro'] ?>" readonly>
                                                        </div>
                                                        <div class=" col-md-1  form-group">
                                                            <label for="numero">Nº <span class="text-danger">*</span></label>
                                                            <input type="text" id="numero" name="numero" class="form-control obrigatorio input-invisivel rounded-pill numero" value="<?= $dados_colaborador['numero'] ?>" readonly>
                                                        </div>
                                                        <div class=" col-md-4  form-group">
                                                            <label for="complemento">Complemento </label>
                                                            <input type="text" id="complemento" name="complemento" class="form-control input-invisivel rounded-pill complemento" value="<?= $dados_colaborador['complemento'] ?>" readonly>
                                                        </div>
                                                        <div class="col-md-4  form-group">
                                                            <label for="bairro">Bairro <span class="text-danger">*</span></label>
                                                            <input type="text" id="bairro" name="bairro" class="form-control obrigatorio input-invisivel  rounded-pill bairro" value="<?= $dados_colaborador['bairro'] ?>" readonly>
                                                        </div>
                                                        <div class=" col-md-4  form-group">
                                                            <label for="cidade">Cidade <span class="text-danger">*</span></label>
                                                            <input type="text" id="cidade" name="cidade" class="form-control obrigatorio input-invisivel rounded-pill cidade" value="<?= $dados_colaborador['cidade'] ?>" readonly>
                                                        </div>
                                                        <div class="col-md-2 form-group">
                                                            <label for="estado">Estado <span class="text-danger">*</span></label>
                                                            <input type="text" id="estado" name="estado" class="form-control obrigatorio input-invisivel rounded-pill estado" value="<?= $dados_colaborador['estado'] ?>" readonly>
                                                        </div>
                                                ...
                                                <div class="text-center botaoDadosEmpresa mt-5">
                                                    <input type="hidden" name="codigoUsuario" value="<?= $usuario_codigo ?>">
                                                    <button type="submit" class="btn btn-success rounded-pill " name="action" value="atualizarDadosEmpresa">
                                                        Salvar
                                                    </button>
                                                </div>
                                            </form>
                                            ...
                                            <div class="body-multi-content px-0">
                                                <div class="row">
                                                    <div class="col-md-5 form-group">
                                                        ...
                                                        <input type="text" id="beneficiario" name="beneficiario" class="form-control obrigatorio input-invisivel rounded-pill" value="<?= $dados_colaborador['beneficiario'] ?>" readonly>
                                                    </div>
                                                    <div class="col-md-3 form-group">
                                                        <label for="tipoDocumento">Tipo</label>
                                                        <input type="text" id="tipoDocumento" name="tipoDocumento" class="form-control tipo obrigatorio input-invisivel rounded-pill" value="<?= $dados_colaborador['tipoDocumento'] ?>" readonly>
                                                        </input>
                                                    </div>
                                                    <div class="col-md-4 form-group">
                                                        <label for="documento">Documento</label>
                                                        <input type="text" id="documento" name="documento" class="form-control  obrigatorio input-invisivel rounded-pill documento" maxlength="18" value="<?= $dados_colaborador['documento'] ?>" readonly>
                                                    </div>
                                                    <div class="col-md-4 form-group">
                                                        <label for="bancoNumero">Banco</label>
                                                        <input type="text" id="bancoNumero" name="bancoNumero" class="bancoNumero form-control obrigatorio  input-invisivel rounded-pill" value="<?= $dados_colaborador['bancoNumero'] . ' - ' . $dados_colaborador['banco'] ?>" readonly>
                                                    </div>
                                                    <div class="col-md-2 form-group">
                                                        <label for="agencia">Agência</label>
                                                        <input type="text" id="agencia" name="agencia" class="number form-control obrigatorio input-invisivel rounded-pill" maxlength="4" value="<?= $dados_colaborador['agencia'] ?>" readonly>
                                                    </div>
                                                    <div class="col-md-2 form-group">
                                                        <label for="digitoAgencia">Dígito agência</label>
                                                        <input type="text" id="digitoAgencia" name="digitoAgencia" class="number form-control obrigatorio input-invisivel rounded-pill" maxlength="1" value="<?= $dados_colaborador['digitoAgencia'] ?>" readonly>
                                                    </div>
                                                    <div class="col-md-2 form-group">
                                                        <label for="conta">Conta</label>
                                                        <input type="text" id="conta" name="conta" class="number form-control obrigatorio input-invisivel rounded-pill" maxlength="12" value="<?= $dados_colaborador['conta'] ?>" readonly>
                                                    </div>
                                                    <div class="col-md-2  form-group">
                                                        <label for="digitoConta">Dígito conta</label>
                                                        <input type="text" id="digitoConta" name="digitoConta" class="number form-control obrigatorio input-invisivel rounded-pill" maxlength="1" value="<?= $dados_colaborador['digitoConta'] ?>" readonly>
                                                    </div>
                            ...
                            <div class="card-body">
                                <div class="px-2" data-value="alterarSenha">
                                    <div class="px-3 senha">
                                        <form id="formAlterarSenha" class="formValidar" data-value="alterarSenha" name="formAlterarSenha" action="cadastroDados.php" method="post">
                                            <div class="body-multi-content px-0">
                                                <div class="row">
    ...
    <script src="js/dadosCadastrais.js?30"></script>
</body>
