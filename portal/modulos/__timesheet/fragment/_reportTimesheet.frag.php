...
<head>
    ...
    <link rel="stylesheet" href="<?php echo HTTP_SERVER; ?>portal/modulos/timesheet/css/style.css?20" />
                ...
                <div class="row align-items-center">
                        ...
                        <form id="formFiltro">
                            <div class="col-6 form-group">
                                <div class="d-md-flex align-items-center">
                                    <input type="text" id="filtroInicio" name="inicio" class=" d-none form-control rounded-pill mask-data data input-modal">
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="text-right d-flex align-items-center">
                            <div id="reportrange" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc;" class="mb-2">
...
<script type="text/javascript" src="<?php echo HTTP_SERVER; ?>portal/modulos/timesheet/js/logicaReport_function.js?10"></script>
<script type="text/javascript" src="<?php echo HTTP_SERVER; ?>portal/modulos/timesheet/js/reportTimesheet_function.js?20">
</script>
