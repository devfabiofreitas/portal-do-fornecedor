...
$sqlCommand .= ' VALUES ';
$sqlCommand .=  '( ';
$sqlCommand .= '\'' . addslashes($do->prepareDataToSQLQuery("r", $params['Portal_codigo']))  . '\', ';
...
$sqlCommand .= '\'' . addslashes($do->prepareDataToSQLQuery("r", $params['Tags']))  . '\', ';
...
$do->commit();
if ($result) {
  echo '{"success":true, "message": "Marcação cadastrada com sucesso"}';
  exit;
} else {
