    ...
    <div class="sidebar-content h-100">
      ...
      <ul class="list-unstyled components" id="menu-sidebar">
        ...
        if ($usuarioSessao['clt'] == 'N') {
          ?>
          <li id="projetos" class="menus">
            <a href="javascript:void(0)" onclick="link('notasFiscais/public/')" class="btnSidebar">
              <div class="w-100 d-flex align-items-center">
        ...
        if ($usuarioSessao['clt'] == 'S') {
          ?>
          <li id="projetos" class="menus">
            <a href="javascript:void(0)" onclick="link('holerite/public/')" class="btnSidebar">
              <div class="w-100 d-flex align-items-center">
                <svg id="Camada_2" data-name="Camada 2" xmlns="http://www.w3.org/2000/svg" width="15.422" height="19.968"
                  viewBox="0 0 15.422 19.968">
                  <g id="Camada_1" data-name="Camada 1" transform="translate(0 0)">
        ...
        <li id="projetos" class="menus">
          <a href="javascript:void(0)" onclick="link('timesheet/public/')" class="btnSidebar">
            <div class="w-100 d-flex align-items-center">
        ...
        <li id="projetos" class="menus">
          <a href="javascript:void(0)" onclick="link('autoAvaliacaoTecnica/public/')" class="btnSidebar">
                    ...
                    <g id="Group_898" data-name="Group 898" transform="translate(57 28)">
                      <g id="Group_897" data-name="Group 897">
                        <path id="Path_4645" data-name="Path 4645"
                          d="M15.174,3H7.835A1.835,1.835,0,0,0,6,4.835V19.514a1.835,1.835,0,0,0,1.835,1.835H18.844a1.835,1.835,0,0,0,1.835-1.835V8.5Z"
                          transform="translate(461 567)" fill="none" stroke="#ccc" stroke-linecap="round"
                          stroke-linejoin="round" stroke-width="1.5" />
                        <path id="Path_4646" data-name="Path 4646" d="M21,3V8.5h5.5" transform="translate(455.174 567)"
                          fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
                      </g>
                      <line id="Line_99" data-name="Line 99" x2="9.342" transform="translate(469.5 581.913)" fill="none"
                        stroke="#ccc" stroke-linecap="round" stroke-width="1.5" />
                      <line id="Line_101" data-name="Line 101" x2="9.342" transform="translate(469.5 578.913)"
                        fill="none" stroke="#ccc" stroke-linecap="round" stroke-width="1.5" />
                      <line id="Line_102" data-name="Line 102" x2="3" transform="translate(469.5 575.913)" fill="none"
                        stroke="#ccc" stroke-linecap="round" stroke-width="1.5" />
                      <line id="Line_103" data-name="Line 103" x2="3" transform="translate(469.5 572.913)" fill="none"
                        stroke="#ccc" stroke-linecap="round" stroke-width="1.5" />
                      <line id="Line_100" data-name="Line 100" x2="9.342" transform="translate(469.5 584.913)"
                        fill="none" stroke="#ccc" stroke-linecap="round" stroke-width="1.5" />
                    </g>
                  </g>
                </svg>
